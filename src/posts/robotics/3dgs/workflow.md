...
<img src="../../../img/robotics/3dgs/3dgs_workflow.svg" width="800">
...
3. インポートした3DGSを編集する
    ...
    - 原点位置と座標系の向きを変更する
        インポート時には意図していない位置・向きにワールド座標系が存在することが多く、編集の際に不便となることがあります。そこでまず並進移動と回転のツールを用いて対象物とワールド座標系の位置・向きを合わせます。

        <img src="../../../img/robotics/3dgs/supersplat_tools.png" width="600">
        <img src="../../../img/robotics/3dgs/supersplats_coordinate.png" width="600">
...
4. 編集した3DGSを保存する
    ...
    <img src="../../../img/robotics/3dgs/supersplat_save.png" width="800">
<br>
