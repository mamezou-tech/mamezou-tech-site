...
:::info:【少し補足です】WBS（Work Breakdown Structure）とは
これはプロジェクト全体の仕事を、細かく分解したものです。
管理しやすい「作業一覧表」のようなものだと考えてください。
『新製品の開発』といった大きな仕事を、具体的な作業単位に分解します。
要件定義・設計・実装・テストなどに分けて見える化するんですね。
これを作っておくことで、作業の抜け漏れを防いだり、スケジュールを管理しやすくなったりします。
PMとして、まずこのWBSを正確に読み解けるようになることが大切ですよ。
:::
...
:::info:【少し補足です】ステークホルダー（Stakeholder）とは
プロジェクトに影響を与えたり、逆にプロジェクトから影響を受けたりする関係者のことですね。
例えば、チームのメンバー、お客様、上司、関連部署の方々、経営層など、たくさんの人々がいます。
彼ら彼女らの顔を思い浮かべながら仕事を進めることが、PMには求められます。
:::
