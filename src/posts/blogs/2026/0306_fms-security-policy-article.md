...
**管理アカウントのFMSコンソール**
- 自動修復の有効設定
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-5.png)
...
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-6.png)

FMS作成のWeb ACLはALBなどのリソースへの紐づけはされず、
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-7.png)

代わりに既存Web ACLにルールが追加されます。
「ShieldMitigationRuleGroup_...」という名前のルールが既存Web ACLのルールの最後に追加されていることが確認できます。
これがDDoS保護のためのルールのようです。
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-8.png)
...
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-9.png)
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-10.png)
...
**管理アカウントのFMSコンソール**
- 削除
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-11.png)
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-12.png)


**メンバーアカウントのコンソール画面**
- WAF&Shieldコンソール
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-13.png)
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-14.png)

- Configコンソール
ルールが削除されるので「利用不可」になる。
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-15.png)
...
**管理アカウントのコンソール画面**
該当設定箇所
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-16.png)

**メンバーアカウントのコンソール画面**
ポリシー設定後のWAF画面
リソースに関連付けされていない独自のWeb ACLがあり（事前に作成しているもの）、
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-17.png)

ConfigコンソールのFMS作成ルールでのステータス
自動修復がOFFであり、ALBにはどのACLも関連付けされていないため、FMS WAFポリシーによる評価が非準拠になる。
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-18.png)


**管理アカウントのコンソール画面**
ポリシー適用後のFMSコンソール画面
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-19.png)
...
**管理アカウントのコンソール画面**
該当設定の更新
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-20.png)

**メンバーアカウントのコンソール画面**
fmsが作成したDDoS対策用Web ACLがALBに関連付けられている
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-21.png)

Configルールも準拠になった
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-22.png)

**管理アカウントのコンソール画面**
しばらくまってから管理コンソールを確認すると
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-23.png)
...
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-24.png)
↓
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-25.png)
↓
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-26.png)
このようにfms管理のWeb ACLが外れ、独自Web ACLが設定されている状態となる。

**管理アカウントのコンソール画面**
次に、管理アカウントから置換ONに変更してみる。
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-27.png)

**メンバーアカウントのコンソール画面**
すると、メンバーアカウント上でのACLの状態が、
fms管理のWeb ACL
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-28.png)

独自に作ったWeb ACL
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-29.png)
...
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-30.png)
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-31.png)

**管理アカウント上のコンソール**
管理アカウントでのWAFポリシー設定を「置換OFFの状態で、RetrofitをONにする」
RetrofitON
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-32.png)

RetorfitがONだと、自動で置換モードが選択できなくなる（以下の補足参照）
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-33.png)

**メンバーアカウント上のコンソール**
fms管理のWeb ACLはリソースへの紐づけがありませんが、
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-34.png)

独自に作成したWeb ACLにはFMSのルールが注入されています。
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-35.png)
![alt text](/img/blogs/2026/0305_fms-security-policy-article/image-36.png)
...
### ポリシー適用後のステップ
今回はボリューム感が大きくなってきたため扱えませんでしたが、FMSポリシーを設定したあとのステップとしては、
- Shield Advancedポリシーで検知した攻撃を管理者へ通知（SNSやCloudWatchアラームの活用）する
- 保護対象リソースに対するリクエストをログとしてS3バケットに分析用にためておき、Athenaで分析できるようにする
などの、通知・分析・対策、に関するサービス連携が考えられると思います。
私自身も今後のPJの中でこれらは実施していく予定ですので、また皆さんに共有すべき事項が出てきた場合にはまとめてみようと思います。
