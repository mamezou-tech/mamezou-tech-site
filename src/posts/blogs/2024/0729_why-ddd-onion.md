...
- よって、これにはDIPを基盤としたオニオンやヘキサゴナル、クリーンアーキテクチャといったアーキテクチャスタイルがフィットする
...
**INさん**：社内外を問わず活躍されているオブジェクト指向界のまさに重鎮。自社の人間を重鎮というのは少しイタい気がするが、名前を聞いて重鎮ということに意を唱える人は恐らくいないでしょう
