---
 ...
 author: hitomi-takeda <- 英小文字で姓名間は半角ハイフンで区切ってください
...
![resized_patchcore_origin_result.png](attachment:33524c7d-4e13-48a6-bb4c-e8b86a25343d.png)
...
![resized_patchcore_align_result.png](attachment:1cf31151-e773-4ead-ab1c-91fdd8ad6109.png)
...
![resized_patchcore_bright_result.png](attachment:99f07530-91cc-42ce-9592-0c950db93247.png)

4. 位置ずれナシ・明るさ一定・背景変更
背景にバラエティを持たせるため、ランダムにカラフルな四角を描画したものです。
閾値を0.41にすると再現率=1になります。  
このとき適合率：1.0、AUC:1.0となり、こちらも元の加工していないデータよりも良い結果が出ています。
![resized_patchcore_random_square_result.png](attachment:8d4b96a4-19e4-497f-96d8-f00f044f04a5.png)
...
![resized_rtmdet_normal_result.png](attachment:2180f5e8-01a1-4795-95a4-51feeebde69d.png)

2. 位置ずれアリ・明るさ一定・背景一定
閾値0.5で再現率=1になります。  
このとき適合率：1.0、AUC:1.0となりました。位置ずれはほとんど影響なしと言えます。

![resized_rtmdet_align_result.png](attachment:461ab58a-fec4-4534-8380-8ea1db5c4fc8.png)
   
3. 位置ずれナシ・明るさ変更・背景一定
閾値0.5で再現率=1になります。  
このとき適合率：1.0、AUC:1.0となりました。明るさの変更に対してもロバストなようです。
![resized_rtmdet_bright_result.png](attachment:4e7e0f07-0cd2-45b8-838c-15f13f238e06.png)
4. 位置ずれナシ・明るさ一定・背景変更
閾値0.5で再現率=1になります。  
このとき適合率：1.0、AUC:1.0となりました。背景の変化もほとんど影響しないようでした。
![resized_rtmdet_square_result.png](attachment:1d28f72c-7746-43f9-b89c-dcb4a892a0e0.png)
...
![aws_origin_result.png](attachment:0a2d373a-1e39-4893-8215-c3ab28761957.png)

2. 位置ずれアリ・明るさ一定・背景一定
位置ずれデータではF1スコア88.9%となり、元データよりも良い結果です。
![aws_align_result.png](attachment:25c7c804-843d-40f2-a327-c7f097cb3ac2.png)

3. 位置ずれナシ・明るさ変更・背景一定
明るさを変更したデータではF1スコアは81.8%となり、元データとあまり変わらない結果が出ました。
![aws_bright_result.png](attachment:1f31ec99-06a6-4ab4-aef0-606e61c87f88.png)

4. 位置ずれナシ・明るさ一定・背景変更
背景にランダムに四角を描画したデータではF1スコアは85.7%でした。
![aws_randomsquare_result.png](attachment:3d778395-a9bb-4ea8-b00c-9959a6c34e81.png)
