...
本章では、[AWS Pricing MCP Server](https://awslabs.github.io/mcp/servers/aws-pricing-mcp-server) の役割と、それを Spec Kit のワークフロー、とくに Implement フェーズのあとに統合することで、コストの観点からどのように制約をかけられるか解説します。
...
- CloudFront からのみアクセスできるよう、OAI（Origin Access Identity）を利用する
