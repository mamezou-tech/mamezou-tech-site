...
昨今のシステム開発は公開された技術を組み合わせることで効率的に価値を提供できるようになってきています。しかし、その帰結としてシステムを「どこまで保証するべきか」については非常に難易度が上がってきています。最近発声した[CrowdStrike起因のシステム停止トラブル](https://japan.zdnet.com/article/35221937/)や[polyfill.ioによるマルウェア混入](https://news.mynavi.jp/techplus/article/20240628-2974852/)などの事例は開発したアプリケーションが持つ問題というよりもシステムに含まれる要素に起因した、アプリケーションそのものに問題が無くても発生する事象になります。  
