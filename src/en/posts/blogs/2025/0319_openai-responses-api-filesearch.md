...
[^2]: The Assistants API was able to retrieve the source corresponding to annotation marks (e.g., `【4:10†foo】`) within the referenced text, but it seems the Responses API cannot retrieve them.
