...
タックシールに関しては、ダイソーの [タックシール キレイにはがせるタイプ ５２５枚](https://jp.daisonet.com/products/4550480482910) をおすすめします。こちらは SO-101 のほぼ全てのパーツの大きさに対応しており、下記画像のようにラベリングが可能になります。

| ![motor_labeling](/img/robotics/lerobot/motor_labeling.jpg) | ![follower_labeling](/img/robotics/lerobot/follower_labeling.jpg) |
|---|---|
| タックシールを用いて、モーターをラベリングしている時の画像。 | タックシールを用いて、モーターバスをラベリングしている時の画像。 |
