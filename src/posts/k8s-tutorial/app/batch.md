...
Kubernetesを利用する主なメリットとして、セルフヒーリング等の耐障害性強化や、大規模トラフィックに耐えられるスケーラビリティが得られる印象が強いかと思います。
このような背景から、Kubernetesを持続的(long-running)な稼働が求められるWebアプリケーション用のものと想像する方が多いですが、バッチ処理のようなワンショットのジョブにも対応しています。
